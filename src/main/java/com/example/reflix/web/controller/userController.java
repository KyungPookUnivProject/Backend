...
public class userController {
    ...
    public ResponseEntity userDetail(@AuthenticationPrincipal userPrinciple user){
    ...
    public ResponseEntity out(@RequestBody String Email,String password,@AuthenticationPrincipal userPrinciple user){
